<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    @foreach (auth()->user()->roles as $role)
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item {{ request()->is('admin/users') || request()->is('admin/users/*') ? 'active' : '' }}"
                        ...
                        {{ __('Pengguna') }}</a>
                    <a class="collapse-item {{ request()->is('admin/instansion') || request()->is('admin/instansion/*') ? 'active' : '' }}"
                        href="{{ route('admin.instansions.index') }}"> <i class="fa fa-user mr-2"></i>
                        {{ __('Instansi') }}</a>
                </div>
            </div>
        </li>
        ...
        <li
            class="nav-item {{ request()->is('admin/questions') || request()->is('admin/questions') ? 'active' : '' }}">
        ...
        @elseif ($role->title == "evaluator")
        <li
            class="nav-item {{ request()->is('evaluator/review ') || request()->is('evaluator/review ') ? 'active' : '' }}">
