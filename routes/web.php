...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('test/{result_id}/revisi', [\App\Http\Controllers\TestController::class, 'revisi'])->name('client.test.revisi');
    ...
    Route::group(['middleware' => 'isAdmin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
        ...
        // categories
        Route::resource('instansions', \App\Http\Controllers\InstansionController::class);
        Route::delete('instansions_mass_destroy', [\App\Http\Controllers\InstansionController::class, 'massDestroy'])->name('instansions.mass_destroy');
    ...
    Route::group(['middleware' => 'isAdmin','prefix' => 'evaluator', 'as' => 'admin.'], function() {
